...
export default function CourseDetail({ categoryName, course }: CourseDetailProps) {
  ...
  const [activeTab, setActiveTab] = useState<'description' | 'curriculum' | 'review' | 'request'>(
    'description',
  );
          ...
          <div className={styles.main}>
            ...
            <section className={styles.section}>
              ...
              {activeTab === 'curriculum' && (
                <CourseCurriculum contents={course.contents || []} mode="view" />
              )}
              {activeTab === 'review' && (
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.summaryCard}>
              ...
              <div className={styles.ctaGroup}>
                <Button variant="cta" type="button" onClick={handleAddToCart}>
                  <Image
